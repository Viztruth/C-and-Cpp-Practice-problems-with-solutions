//Program to create and display Symmetric matrix using lower triangular matrix using 2d array
//Vishruth codes
#include<stdio.h>
...
int main()
{
    ...
    int str[totele];
    printf("\nEnter the lower tri. elements row-major wise (separated by space): ");
