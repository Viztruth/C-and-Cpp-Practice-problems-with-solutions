//Program to create and display Symmetric matrix using upper triangular matrix using 2d array
//Vishruth codes
#include<stdio.h>
...
int main()
{
    ...
    printf("\nEnter the dimension: ");
    scanf("%d",&m.n);
    //count of non zerp elements in a upper triangular matrix is sum of
    //first n terms of dimension
    int totele=((m.n)*(m.n+1))/2;
    int str[totele];
    printf("\nEnter the upper tri. elements row-major wise (separated by space): ");
